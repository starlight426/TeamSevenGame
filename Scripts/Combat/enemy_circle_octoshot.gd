...
func fire():
	fire_ready = false
	AttackSpawner.spawn_bullets($bullet_marker_1.global_position,PI/2,"single",1,0,"default","circle","straight",2000,3,30,"circle","purple",0,0,0)
	...
	AttackSpawner.spawn_bullets($bullet_marker_1.global_position,PI/6,"single",1,0,"default","circle","straight",2000,3,30,"circle","purple",0,0,0)
