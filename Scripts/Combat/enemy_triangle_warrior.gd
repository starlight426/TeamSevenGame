...
func _ready() -> void:
	...
	$DodgeDetector.update_parent_target.connect(update_closest_danger)
...
func fire():
	fire_ready = false
	AttackSpawner.spawn_bullets($bullet_marker_1.global_position,global_rotation,"single",1,0,"default","triangle","straight",2000,3,10,"triangle","purple",0,0,0)
	AttackSpawner.spawn_bullets($bullet_marker_2.global_position,global_rotation,"single",1,0,"default","triangle","straight",2000,3,10,"triangle","purple",0,0,0)
	AttackSpawner.spawn_bullets($bullet_marker_3.global_position,global_rotation,"single",1,0,"default","triangle","straight",2000,3,10,"triangle","purple",0,0,0)
	AttackSpawner.spawn_bullets($bullet_marker_4.global_position,global_rotation,"single",1,0,"default","triangle","straight",2000,3,10,"triangle","purple",0,0,0)
	AttackSpawner.spawn_bullets($bullet_marker_5.global_position,global_rotation,"single",1,0,"default","triangle","straight",2000,3,10,"triangle","purple",0,0,0)
...
func update_closest_danger(body):
	closest_danger = body
