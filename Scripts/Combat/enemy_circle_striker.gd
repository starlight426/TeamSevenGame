...
func fire():
	fire_ready = false
	AttackSpawner.spawn_bullets($bullet_marker_1.global_position,global_rotation-3*PI/4,"single",1,0,"default","circle","striker",2000,3,10,"circle","purple",PI/120,target,0)
	AttackSpawner.spawn_bullets($bullet_marker_2.global_position,global_rotation+3*PI/4,"single",1,0,"default","circle","striker",2000,3,10,"circle","purple",PI/120,target,0)
